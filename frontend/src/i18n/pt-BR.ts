const ptBR = {
  ...
  entities: {
    ...
    car: {
        ...
        label: 'Cars',
        menu: 'Cars',
        exporterFileName: 'Car_exportados',
        list: {
          menu: 'Cars',
          title: 'Cars',
        },
        create: {
          success: 'Car salvo com sucesso',
        },
        update: {
          success: 'Car salvo com sucesso',
        },
        destroy: {
          success: 'Car deletado com sucesso',
        },
        destroyAll: {
          success: 'Car(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Car',
        },
        ...
        view: {
          title: 'Visualizar Car',
        },
        importer: {
          title: 'Importar Cars',
          fileName: 'car_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
